...
class Generator {
    ...
    _loadGeneratorPackages() {
        ...
        do {
            ...
            this.options.generator.forEach(pack => {
                if (Object.keys(this.packages).includes(pack)) return;
                ...
                this.packages[pack] = { ...options, packageName };
                this.options.merge(options);
            });
        } while (
            _.difference(this.options.generator, Object.keys(this.packages))
                .length !== 0
        );
    }
    ...
    getCommitMessage() {
        const versionString = Object.entries(this.packages)
            .map(
                ([pack, options]) =>
                    `generated by ${options.packageName}@${options.version}`
            )
            .join('\\n');
        return `${versionString}\\ngenerated by gen-lib@${app.version}`;
    }
